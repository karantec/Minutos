        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="flex flex-col">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/contact" className="hover:underline text-white/80 hover:text-white transition-colors duration-200 text-sm md:text-base">
                  Contact us
                </Link>
              </li>
            </ul>
          ...
          <div className="flex flex-col">
            ...
            <ul className="space-y-2 flex flex-col md:flex-row md:space-y-0 md:space-x-4">
              <li>
                <Link href="https://instagram.com" className="hover:underline text-white/80 hover:text-white transition-colors duration-200 flex items-center text-sm md:text-base" target="_blank" rel="noopener noreferrer">
              ...
              <li>
                <Link href="https://twitter.com" className="hover:underline text-white/80 hover:text-white transition-colors duration-200 flex items-center text-sm md:text-base" target="_blank" rel="noopener noreferrer">
                  <svg className="w-4 h-4 mr-2" viewBox="0 0 24 24" fill="currentColor">
